...
REG2 : PROCESS(CS, CT0, CT1, START, SHOW_SUM, SHOW_LAST, PAUSE)
BEGIN
CASE CS IS
	WHEN S0 =>
		NS <= S1;
	WHEN S1 => 
		...
		ELSIF SHOW_LAST = '1' THEN NS <= SLAST;
		ELSE NS <= S1;
		END IF;
	WHEN SRUN0 => 
		NS <= SRUN1;
...
COM1 : PROCESS(FLASH, CS, M0, M1, H0, H1)
BEGIN
IF CS = SCT0 THEN
	IF FLASH = '0' THEN
		MM0 <= "1011";
...
REG3 : PROCESS(CLK, CS, SHOW_DIS, DIS0, DIS1, DIS2, DIS3, COST0, COST1, COST2, COST3, MM0, MM1, HH0, HH1, LAST_DATA, SUM_DATA)
BEGIN
